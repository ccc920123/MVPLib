...
//	String config=	mActivity.getClass().getPackage().toString().replaceAll(".","_");
		
		SharedPreferences sp = mActivity.getSharedPreferences("resofvehconfig",
    ...
    public static boolean remove(Context mActivity, String key) {
        SharedPreferences sharedPreference = mActivity.getSharedPreferences("resofvehconfig", Context.MODE_PRIVATE);
