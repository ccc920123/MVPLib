 ...
 * 修改时间：
 */
public class UpLoadApkDialogActivity extends Activity {
     ...
     */
    public static void statAction(Context ct, String url, String apkName) {
        Intent it = new Intent(ct, UpLoadApkDialogActivity.class);
